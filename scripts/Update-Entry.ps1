...
$result = Invoke-RestMethod -Headers $CadenceHeaders "$ApiBase/api/plugins/builderio/content/$Model/$Id" -Method PATCH -ContentType "application/json; charset=utf-8" -Body $body
